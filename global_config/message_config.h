...
uchar_vec NEW_PERM{'N','E','W','_','P','E','M'};

// Request a permission to be updated.
// Should be followed by the Permission to be updated at the destination.
uchar_vec UPDATE_PERM{'U','P','D','A','T','E','_','P','E','R','M'};

// Request a permission.
uchar_vec GET_PERM{'G','E','T','_','P','E','R','M'};

// Request a permission to be deleted.
// Should be followed by the Permission to be deleted.
uchar_vec DELETE_PERM{'D','E','L','E','T','E','_','P','E','R','M'};

// Request a credential. 
// Should be followed by set_name;version.
uchar_vec GET_CRED{'G','E','T','_','C','R','E','D'};
...
uchar_vec NEW_CRED{'N','E','W','_','C','R','E','D'};

// Used to ping one of the services.
uchar_vec PING{'P','I','N','G'};
...
uchar_vec REQUEST_ENCRYPT{'R','E','Q','U','E','S','T','_','E','N','C','R','Y','P','T'};

// Used to request decryption services from the local daemon.
// Should be followed by the set, version, and then the actual data to encrypt.
uchar_vec REQUEST_DECRYPT{'R','E','Q','U','E','S','T','_','D','E','C','R','Y','P','T'};
...
uchar_vec REQUEST_HMAC{'R','E','Q','U','E','S','T','_','H','M','A','C'};

// Used to request signing services from the local daemon.
// Should be followed by the set, version, data ,and then the hash type to use.
uchar_vec REQUEST_SIGN{'R','E','Q','U','E','S','T', '_','S','I','G','N'};
...
// to use.
uchar_vec REQUEST_VERIFY{'R','E','Q','U','E','S','T','_','V','E','R','I','F','Y'};
...
uchar_vec INVALID_REQUEST{'I','N','V','A','L','I','D','_','R','E','Q','U','E','S','T'};
